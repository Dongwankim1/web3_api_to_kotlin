...
/**
 * packageName    : app.saferoadclub.api.spending.service
 * fileName       : TOKEN_PROGRAM_2022
 * author         : mac
 * date           : 2/6/25
 * description    :
 * ===========================================================
 ...
 */
public class TOKENPROGRAM2022 extends Program {
...
//            org.p2p.solanaj.programs.TokenProgram.AuthorityType authorityType
//    ) {
//        List<AccountMeta> keys = new ArrayList<>();
//        keys.add(new AccountMeta(accountPubkey, false, true));
